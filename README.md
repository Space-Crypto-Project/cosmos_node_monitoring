...
```
wget -O install_exporters.sh https://github.com/Cosmos-TechHub/cosmos_node_monitoring/master/install_exporters.sh && chmod +x install_exporters.sh && ./install_exporters.sh
```
